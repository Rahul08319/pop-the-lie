        ...
        <div className="flex items-center gap-2 pointer-events-auto">
          <div className="apple-card px-4 py-1.5 rounded-full flex items-center gap-3 border border-white/15 bg-black/40 backdrop-blur-xl shadow-lg">
            <div className="flex flex-col">
              <span className="text-[10px] font-semibold tracking-wider text-white/50 uppercase">Score</span>
              <span className="font-apple-display text-lg font-bold text-[#f5c518] leading-none">
                {gameState.score}
              </span>
            </div>
            <div className="w-px h-6 bg-white/15" />
            <div className="flex flex-col">
              <span className="text-[10px] font-semibold tracking-wider text-white/50 uppercase">Lvl</span>
              <span className="font-apple-display text-lg font-bold text-white leading-none">
                {gameState.level}
              </span>
            </div>
          </div>
